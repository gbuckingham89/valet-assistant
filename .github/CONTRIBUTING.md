...
- **Static analysis** - [Larastan](https://github.com/nunomaduro/larastan) is used, please ensure there are no issues. 

- **Add tests!** - Your patch won't be accepted if it doesn't have passing tests.
